...
class FaceEyeDetection(Node):
    def __init__(self,name):
        ...
        self.eyeDetect = cv.CascadeClassifier( "/home/yahboom/orbbec_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/file/haarcascade_eye.xml")
        self.faceDetect = cv.CascadeClassifier(
"/home/yahboom/orbbec_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/file/haarcascade_eye.xml")
...
def main():
    rclpy.init()
    if os.getenv('CAMERA_TYPE') == 'gemini335':
